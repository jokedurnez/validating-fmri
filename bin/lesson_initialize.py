...
ROOT_CITATION = '''\
Joke Durnez (eds): "Validating statistical methods for fMRI"
'''
...
1.  If you wish to change this lesson,
    please work in <https://github.com/jokedurnez/validating-fmri>,
    which can be viewed at <https://jokedurnez.github.io/validating-fmri>.
